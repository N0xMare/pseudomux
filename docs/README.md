...
**To use pmux, read the root [README](../README.md).** Pi setup is
[examples/pi](../examples/pi/README.md). Interactive sessions (experimental)
are [experimental-path-a.md](experimental-path-a.md).

Everything else in this directory is engineering: pool internals, compatibility
receipts, test ownership, and dated measurements. It is not the product
landing page.
